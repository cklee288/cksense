...
if (file_exists("/usr/local/bin/git")) {
	...
	$section->addInput(new Form_Input(
		...
		))->setHelp('The most recently used branch was "%1$s". (Usually the branch name is RELENG_2_4_5)' .
	...
	$group->setHelp('See "playback gitsync --help" in console "PHP Shell + ckSense tools" for additional information.');
	$section->add($group);
